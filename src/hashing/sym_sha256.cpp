...
std::pair<SymBitVec, SymBitVec> SHA256::round(
    const SymBitVec &a, const SymBitVec &b, const SymBitVec &c,
    const SymBitVec &d, const SymBitVec &e, const SymBitVec &f,
    const SymBitVec &g, const SymBitVec &h, int i, const SymBitVec &ki) {
