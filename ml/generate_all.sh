...
python -m dataset_generation.generate --num-samples 10 --num-input-bits 64 --hash-algo orConst

python -m dataset_generation.generate --num-samples 10 --num-input-bits 64 --hash-algo andConst
