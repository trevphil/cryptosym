...
class PLModelWrapper(pl.LightningModule):
    def __init__(self, opts):
        super().__init__()
        self.opts = opts
        self.model = HashSAT(num_layers=opts.T,
                             hidden_size=opts.d,
...
if __name__ == '__main__':
    ...
    trainer = pl.Trainer(accelerator=None,
                         logger=logger,
    ...
    ckpt_path = './log/2021-09-09-20-28-47_01/version_0/checkpoints/epoch=3-step=783.ckpt'
